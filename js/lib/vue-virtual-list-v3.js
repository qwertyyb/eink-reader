...
var useResize = ((triggerRef, callback, disabledRef) => {
...
const VirtualListItem = defineComponent({
...
var VirtualList = defineComponent({
  ...
  setup(props, {
    ...
    const scrollToOffset = offset => {
      ...
      if (root) {
        console.log(root, root.clientHeight, root.scrollHeight, offset)
  ...
  render() {
    ...
    const wrapperStyle = wrapStyle ? Object.assign({}, wrapStyle, extraStyle) : extraStyle; // root style
